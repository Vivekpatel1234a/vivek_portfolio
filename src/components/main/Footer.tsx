...
const Footer: FC = () => {
  ...
  const socialLinks = [
    {
      href: 'https://github.com/Vivekpatel1234a',
      icon: <RxGithubLogo className="w-5 h-5" />,
      label: 'GitHub',
    },
    {
      href: 'https://www.linkedin.com/in/vivek1315/',
      icon: <FaLinkedin className="w-5 h-5" />,
      label: 'LinkedIn',
    },
    {
      href: 'https://x.com/vivek_404_X',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.div className="space-y-4" variants={childVariants}>
            <h1 className="text-2xl font-extrabold bg-clip-text">Vivek Patel</h1>
        ...
        >
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Built with ❤️ by Vivek Patel.
          </p>
          <p className="text-xs text-muted-foreground">
            Visitors:{' '}
