            ...
            >
              ...
              <div className="space-y-5 text-foreground">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">patelvpv369@gmail.com</span>
                  <button
                    onClick={() => copyToClipboard('patelvpv369@gmail.com', 'Email')}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">+91 80901 32093</span>
                  <button
                    onClick={() => copyToClipboard('+91 8090132093', 'Phone number')}
                    className="text-muted-foreground hover:text-primary transition"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">Ghaziabad, India</span>
                </div>
              </div>
            </motion.div>
